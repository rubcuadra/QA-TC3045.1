...
TEST_P(Fixture,testNameParams)
{
	this->instance2Test->doSomething();
}

INSTANTIATE_TEST_CASE_P(CaseName,Fixture,testing::Values( &instance1 , &instance2, &instanceWithConstParam<8> )) ;
